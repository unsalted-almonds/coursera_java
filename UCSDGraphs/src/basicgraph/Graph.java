...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		// vertices are represented as integers from 0 -  (numVertices - 1)
		...
		for (int i = 0 ; i < this.numVertices; i++){
			res.add(this.getInNeighbors(i).size() + this.getNeighbors(i).size());
		}
		// this is how to sort things in reverse order!!!!
