...
public class MapGraph_my {
	...
	public MapGraph_my()
	{
		...
		this.adjList = new AdjacencyList_my();
	}
	...
	public void addEdge(GeographicPoint from, GeographicPoint to, String roadName,
		...
		this.adjList.addNeibghor(from, to, new MapEdge_my(from,to,roadName,roadType,length));
										  ...
										  GeographicPoint goal, Consumer<GeographicPoint> nodeSearched)
	{
		...
		if (!this.isVertexInMap(start)||!this.isVertexInMap(goal))
			return null;
		
		Map<GeographicPoint,Double> distance = new HashMap<GeographicPoint,Double>();
