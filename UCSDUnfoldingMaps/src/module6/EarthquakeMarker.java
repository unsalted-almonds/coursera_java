...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	// order earthquake in reverse order of its magnitude 
	public int compareTo(EarthquakeMarker quake){
			
		if(this.getMagnitude() > quake.getMagnitude())
			return -1;
		else if (this.getMagnitude() < quake.getMagnitude())
			return 1;
		else
			return 0;
	}
